...
| ID | 요구사항 | 우선순위 | 설명 | 비고 |
|----|----------|--------|------|------|
| FR-027 | 컨텐츠 A | **P0** | 발화 역량 평가를 위한 컨텐츠 유형 A | 컨텐츠 명칭 및 상세 규격은 기획 중 |
| FR-028 | 컨텐츠 B | **P0** | 발화 역량 평가를 위한 컨텐츠 유형 B | |
| FR-029 | 컨텐츠 C | **P0** | 발화 역량 평가를 위한 컨텐츠 유형 C | |

> **⚠️ 비고:** 위 3개 컨텐츠 유형 모두 P0으로 분류되었으나, **난이도에 따라 MVP 우선순위 및 구현 여부를 재조정할 수 있음**. 세부 명칭 및 가중치는 기획 중.
